...
// @author       NotTheDr01ds
// @match        https://stackoverflow.com/users/flag-summary/11810933*
...
const firstPage = "https://stackoverflow.com/users/flag-summary/11810933?group=1&page=1";
...
async function menu (event) {
  ...
  //for (let pageNum = 1; pageNum <= 2; pageNum++) {
    ...
    let url = `https://stackoverflow.com/users/flag-summary/11810933?group=1&page=${pageNum}`;
...
(function() {
  ...
  const menu_command_id_1 = GM_registerMenuCommand("Get Flags", menu);
})();